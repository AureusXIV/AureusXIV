...
CzAureusXIVWallet* zwalletMain = NULL;
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the AureusXIV and zAureusXIV money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all AureusXIV specific functionality (Fundamentalnodes, Zerocoin, SwiftX, Budgeting) (0-1, default: %u)"), 0));
    ...
    strUsage += HelpMessageOpt("-backupzVit=<n>", strprintf(_("Enable automatic wallet backups triggered after each zAureusXIV minting (0-1, default: %u)"), 1));
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                //AureusXIV specific: zerocoin and spork DB's
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        zwalletMain = new CzAureusXIVWallet(pwalletMain->strWalletFile);
