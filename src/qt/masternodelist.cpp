                                                  ...
                                                  walletModel(0)
{
    ...
    ui->tableWidgetMasternodes->horizontalHeader()->setDefaultAlignment(Qt::AlignLeft | Qt::AlignVCenter);
    ui->tableWidgetMasternodes->horizontalHeader()->setTextElideMode(Qt::ElideRight);
