...
Users that wish to prevent this behavior (not recommended) can pass `-backupzVit=0` at the command-line when starting the client, or add `backupzVit=0` to their `aureusxiv.conf` file.
