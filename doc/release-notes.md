AXIV Core version *4.5.0* is now available from:  <https://github.com/axivproject/AXIV/releases>
...
Please report bugs using the issue tracker at github: <https://github.com/axivproject/AXIV/issues>
